...
const DaysWeather = () => {
  ...
  return (
    <div
      className="bg-[#D9D9D9] dark:bg-[#444444] text-black dark:text-[#D9D9D9] 
    ...
    >
      {daysForcast.map((day, index) => {
        return (
          <div
            key={index}
            className="p-2 px-3 flex items-center justify-between border-b border-gray-300 dark:border-gray-600 last:border-b-0"
          >
            <img
              src={pickimg(day.entries[0].weather[0])}
              alt="weather"
              className="w-[50px]"
            />
