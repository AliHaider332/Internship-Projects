...
const main = async (DATA) => {
  try {
    ...
    🌐 Social Links: ${JSON.stringify(DATA.links || {}, null, 2)}
    🎨 Theme & Colors: ${DATA.theme || 'Default'}
    ...
    ⚠️ Important:
    - Include social links in the header, footer, or contact section.
    - Apply the theme and color instructions in the design.
