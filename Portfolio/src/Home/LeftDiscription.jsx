...
function LeftDiscription() {
  ...
  return (
    <div className="flex flex-col items-center lg:items-start text-center lg:text-left gap-5 md:gap-6 lg:gap-8 w-full max-w-2xl mx-auto lg:mx-0 px-4 sm:px-0">
      {/* Name Section with Optimized Spacing */}
      <div
        className={`flex flex-col gap-2 md:gap-3 w-full transition-all duration-800 ease-out transform ${
          isVisible
      ...
      >
        ...
        <span className="Roboto text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 dark:text-white leading-tight bg-gradient-to-r from-gray-800 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent">
          Ali Haider
        </span>
      </div>

      {/* Typed Animation Section with Better Spacing */}
      <div
      ...
      {/* Social Links with Better Medium Screen Spacing */}
      <div
        className={`flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4 md:gap-4 transition-all duration-800 ease-out transform ${
          isVisible
            ? 'opacity-100 translate-y-0 scale-100'
            : 'opacity-0 translate-y-8 scale-95'
        }`}
      ...
      <div
        className={`flex flex-col sm:flex-row justify-center lg:justify-start gap-3 md:gap-4 w-full transition-all duration-700 ease-out ${
